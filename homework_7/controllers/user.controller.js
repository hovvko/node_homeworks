...
module.exports = {
    ...
    create: async (req, res, next) => {
        try {
            const {password, name} = req.userOnCreate;

            await emailService.sendMail('bbbbrazzer@gmail.com', emailEnum.REGISTRATION, {userName: name});
    ...
    update: async (req, res, next) => {
        try {
            ...
            res.json(`User with id - ${userID} was updated`);
        } catch (e) {
            next(e);
        }
    },
